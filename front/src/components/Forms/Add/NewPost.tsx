...
import Filecon from "components/Elements/icons/Filecon";
import { AuthUser } from "model/user";
import Image from "next/image";
import { useRouter } from "next/navigation";
import { ChangeEvent, DragEvent, FormEvent, useRef, useState } from "react";
import PostChats from "../Post/PostChats";
...
function NewPost({ user: { username, image } }: INewPost) {
  ...
  return (
    <section className="w-full max-w-xl flex flex-col items-center mt-6 mx-auto ">
      {loading && (
        <div className="absolute inset-0 flex justify-center items-center z-20 pt-[30%] bg-sky-500/20">
      ...
      <PostChats username={username} userImage={image ?? ""} />
